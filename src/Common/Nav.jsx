          ...
          >
                    ...
                    !logOutToggle ? (<>
                        ...
                        >
                          ...
                          <Button
                            ...
                            target="_blank"
                          >
                           <Link to="/forgetpassword" style={{textDecoration : "none", color: "white" }}>Forget Password</Link> 
                           </Button>
                        </Box></>) : (<>
                                    {/* ************ MENU SECTION  ********* */}
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                ...
                <MenuItem
                  ...
                  sx={{ py: '6px', px: '12px' }}>
                  <Typography variant="body2" color="text.primary">
                  <Link to="/addproduct" style={{textDecoration : "none", color: "black" }}> Add_Products </Link> 
                  </Typography>
                </MenuItem>
            ...
            >
                ...
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography textAlign="center"><Link to="/dashboard" style={{textDecoration : "none", color: "black" }} >Dashboard</Link></Typography>
                </MenuItem>
                <Divider />
                <MenuItem  onClick={handleCloseUserMenu}>
                  <Typography textAlign="center"><Link to="/updatepassword" style={{textDecoration : "none", color: "black" }} >Update Password</Link></Typography>
                </MenuItem>
                <MenuItem  onClick={handleCloseUserMenu}>
